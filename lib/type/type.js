...
var nodeInterface = new _type2.GraphQLInterfaceType({
  name: "Node",
  description: "An object with a globally unique id.",
  fields: function fields() {
    return {
      id: {
        type: new _type2.GraphQLNonNull(_type2.GraphQLID),
...
function getType(graffitiModels, _ref2) {
  ...
  // Define type
  console.log(_util2.default.inspect(graphQLType, false, null));
